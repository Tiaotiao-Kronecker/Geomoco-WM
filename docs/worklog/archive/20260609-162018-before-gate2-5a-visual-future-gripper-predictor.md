...
- Next run target: Gate 2.5a visual future-gripper/event predictor, a
  deployable version of the oracle gripper channel using visual/proprio/task
  context rather than GT future action commands.
