...
7. Preserve the attribution ledger for any next positive decoder or candidate
   branch:
...
8. Do not mix Gate 3 action-head metrics with old frozen-action-decoder metrics;
   use them as separate evidence streams.
9. For heavy training, use a GPU-visible shell or approved execution mode; the
