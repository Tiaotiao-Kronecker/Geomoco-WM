...
- Next run target: add multimodal/stochastic future-motion modeling with
  gripper/contact diagnostics before promoting to GeoMoCo-cVAE; stepwise
  attention remains an optional geometry-balanced variant.
...
1. Evaluate multimodal future-motion priors, such as cVAE / diffusion /
