...
4. A clean next branch is either:
   explicit transition/sustain Pareto checkpoint analysis, treating the trade
   as selection not architecture; or a new candidate policy that is audited for
   nonzero candidate-set changes before training full controls.
