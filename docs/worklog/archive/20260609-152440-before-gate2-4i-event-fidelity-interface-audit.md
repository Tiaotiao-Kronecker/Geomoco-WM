...
- Next run target: Gate 2.4i event-fidelity interface audit, testing whether
  future EEF-only motion plus the frozen action decoder contains enough
  information to recover gripper close/open timing, or whether GeoMoCo-WM needs
  explicit future gripper/event channels.
