...
- Next run target: add multimodal/stochastic future-motion modeling with
  step-wise or multi-query visual attention and gripper/contact diagnostics
  before promoting to GeoMoCo-cVAE.
...
1. Add a stronger temporal or multi-query visual predictor so different future
   steps can attend to different visual evidence.
2. Then evaluate multimodal future-motion priors, such as cVAE / diffusion /
